...
Source code is available at \url{https://github.com/mladenpop-oss/bit-pop} under the MIT License. Benchmark scripts 
and example datasets are included in the repository. A Zenodo archive with a citable digital object identifier (DOI) 
is available at \url{https://doi.org/10.5281/zenodo.20043594}.
